...
<div class="card card-outline rounded-0 card-navy">
			...
			<form action="" id="manage-user">
				...
				<div class="form-group">
					...
					<select name="type" id="type" class="form-control form-control-sm rounded-0" required>
						...
						<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Bán hàng</option>
					</select>
				</div>
				<div class="form-group">
	...
	<div class="card-footer">
		<div class="col-md-12">
			<div class="row">
				<button class="btn btn-sm btn-primary rounded-0 mr-3" form="manage-user">Lưu</button>
				<a href="./?page=user/list" class="btn btn-sm btn-default border rounded-0" form="manage-user"><i class="fa fa-angle-left"></i> Hủy</a>
			</div>
		</div>
	</div>
</div>
