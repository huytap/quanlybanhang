...
<script>
	$(document).ready(function() {
		...
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Tạo mới", "promotion_code/manage.php")
		})
		$('.view_data').click(function() {
			uni_modal("<i class='fa fa-bars'></i> Chi tiết", "promotion_code/view.php?id=" + $(this).attr('data-id'))
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Cập nhật", "promotion_code/manage.php?id=" + $(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
