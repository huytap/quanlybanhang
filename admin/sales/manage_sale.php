    ...
    <div class="container-fluid">
        <div class="card card-outline card-outline rounded-0 shadow blur">
                                    ...
                                    <table class="table table-bordered table-striped mb-0">
                                        ...
                                        <thead>
                                            <tr class="bg-gradient-navy-dark">
                                                <th class="text-center px-2 py-1">Món</th>
            ...
            <div class="card-footer py-2 text-right">
                <button class="btn btn-primary rounded-0" form="sale-form">Lưu</button>
                <?php if (!isset($id)) : ?>
...
<noscript id="product-clone">
    <tr>
        ...
        <td class="px-2 py-1 align-middle">
            ...
            <input type="number" class="form-control form-control-sm rounded-0 text-center" min="1" name="product_qty[]" value="1" required>
        </td>
    ...
    $(function() {
        ...
        $('.prod-item').click(function() {
            ...
            if ($('#product-list tbody tr input[name="product_id[]"][value="' + id + '"]').length > 0) {
                alert("Món đã có trong danh sách")
                return false;
            }
