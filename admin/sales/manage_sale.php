        ...
        <div class="container-fluid">
            <form action="" id="sale-form">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 d-none d-lg-block">
                ...
                <div class="border rounded-0 shadow bg-gradient-navy px-1 py-1" id="sales-panel">
                    <div class="row">
                        <div class="col-lg-8 px-0 h-100" id="panel-left">
                                            ...
                                            <div class="tab-pane fade <?= (!$has_active) ? 'active show' : '' ?>" id="cat-tab-<?= $k ?>" role="tabpanel" aria-labelledby="cat-tab-<?= $k ?>-tab">
                                                <div class="row">
                                                    <?php if (isset($prod_arr[$k])) : ?>
                                                        ...
                                                        ?>
                                                            <div id="product-<?= $row['id']; ?>" class=" col-lg-3 col-md-4 col-sm-12 col-6 px-2 py-lg-3 py-2">
                                                                <div class="card text-dark text-decoration-none">
                                                                    <div class="card-body px-1 py-1 py-lg-4 px-lg-4 text-center">
                            ...
                            <table class="table table-bordered table-striped mb-0">
                                ...
                                <thead>
                                    <tr class="bg-gradient-navy-dark">
                                        ...
                                        <th class="text-center px-2 py-1">T. Tiền</th>
