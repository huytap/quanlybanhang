...
<script>
	$(document).ready(function() {
		...
		$('#create_new').click(function() {
			uni_modal("<i class='fa fa-plus'></i> Tạo mới", "categories/manage_category.php")
		})
		$('.view_data').click(function() {
			uni_modal("<i class='fa fa-bars'></i> Chi tiết", "categories/view_category.php?id=" + $(this).attr('data-id'))
		})
		$('.edit_data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Cập nhật", "categories/manage_category.php?id=" + $(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
